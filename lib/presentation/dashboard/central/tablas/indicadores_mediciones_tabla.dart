...
class IndicadoresMedicionesTabla extends StatefulWidget {
  const IndicadoresMedicionesTabla({super.key});

  @override
  State<IndicadoresMedicionesTabla> createState() =>
      _IndicadoresMedicionesTablaState();
}

class _IndicadoresMedicionesTablaState
    extends State<IndicadoresMedicionesTabla> {
  @override

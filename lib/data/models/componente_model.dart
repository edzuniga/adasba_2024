...
class ComponenteModel extends Componente {
  ...
  factory ComponenteModel.fromJson(Map<String, dynamic> json) {
    return ComponenteModel(
      ...
      resultadosEsperados: json['resultados_esperados'],
      activo: json['activo'],
  ...
  ComponenteModel copyWith({
    ...
    int? modificadoPor,
      ...
      ComponenteModel(
        ...
        resultadosEsperados: resultadosEsperados ?? this.resultadosEsperados,
  ...
  factory ComponenteModel.fromComponente(Componente componente) {
    return ComponenteModel(
      ...
      resultadosEsperados: componente.resultadosEsperados,
